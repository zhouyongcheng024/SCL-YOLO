...
def get_params():
    params = {
        'weight': r'./runs/train/exp15/weights/best.pt',  # 训练出来的权重文件
        'cfg': r'./ultralytics/cfg/models/Add/yolov8-C2f-EMA.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
        ...
        'conf_threshold': 0,  # 0.6  # 置信度阈值，有的时候你的进度条到一半就停止了就是因为没有高于此值的了
        'ratio': 0.02  # 0.02-0.1
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'./datasets/images/train/-107-_jpg.rf.1898c56cb647e3d174b9fcfe6f719784.jpg', r'result/9-c3-yolov8-C2f-EMA-21')  # 第一个是检测的文件, 第二个是保存的路径
